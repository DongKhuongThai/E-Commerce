  ...
  return (
    <div>
      <ul>
        ...
        <li>
          <NavLink to="/welcome" exact activeStyle={{color:'red'}}>John</NavLink>
        </li>
        <li>
          <NavLink to="/welcome" exact activeStyle={{color:'red'}}>Peter</NavLink>
        </li>
      </ul>
      ...
      <Switch>
        ...
        <Route exact path='/welcome' render={()=>(
          this.state.loggedIn ? (<Welcome/>):(<Redirect to="/"/>)
        )
        }/>
      </Switch>
    </div>
